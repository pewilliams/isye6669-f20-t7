...
and yields a mixed integer program, since only some variables in our problem take on continuous values, and others, such as the number of units shipped, take on only integer values.   
