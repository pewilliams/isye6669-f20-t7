...
To simplify readibility of the code we also added the following


 


Code that generates constraints: 
...
# this is the extra variable that I mentioned above 
